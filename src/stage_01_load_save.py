...
def  copy_file(source_download_dir, local_data_dir):
    ...
    x = len(list_of_files)
    for file in tqdm(list_of_files, desc = "copying files"):
...
def get_data(config_path):
    ...
    for source_download_dir , local_data_dir in tqdm(zip(source_download_dirs, local_data_dirs), desc = "list of folders"):
